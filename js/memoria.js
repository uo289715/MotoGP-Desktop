...
class Memoria {
  ...
  // Método privado para voltear carta
  voltearCarta(carta) {
  ...
  registrarEventosCartas() {
      // Seleccionar todas las cartas dentro de <main>
      const cartas = document.querySelectorAll("main article");

      // Recorrerlas y asignar un listener de clic
      cartas.forEach((carta) => {
          carta.addEventListener("click", (event) => {
              // Llamamos al método privado usando una arrow function
  ...
  // Método público para barajar cartas
  barajarCartas() {
      ...
      // Barajar el array de cartas (algoritmo Fisher-Yates)
  ...
  // Método privado para reiniciar atributos
  #reiniciarAtributos() {
  ...
  // Método privado para deshabilitar cartas
  #deshabilitarCartas() {
  ...
  // Método privado para comprobar fin del juego
  #comprobarJuego() {
  ...
  // Método privado para cubrir cartas
  #cubrirCartas() {
      // Bloquear el tablero
      this.#tablero_bloqueado = true;
  ...
  // Método privado para comprobar pareja
  #comprobarPareja() {
